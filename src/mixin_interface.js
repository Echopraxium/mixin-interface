...
class $$Object {
  ...
  get name() {
    if (this._name === undefined)
      this._name = this.generateInstanceName();
    return this._name;
  } // 'name' getter
} // $$Object
...
//---------- getStaticMethods ----------
function getStaticMethods(type) {
...
class MixinInterface {
  ...
  static extendsInterface(type, instance) {
    mixins(type, instance,
      {"warn": false, "mergeDuplicates": false});
  ...
  static implementsInterfaces(implementation_class, implemented_types, instance) {
      ...
      mixins(implemented_types, instance,
             {"warn": false, "mergeDuplicates": false});
      ...
      for (var i=0; i<implemented_types.length; i++) {
        ...
        var static_methods = getStaticMethods(k);
  ...
  static implementsInterfaces(implementation_class, implemented_types, instance) {
      ...
      mixins(implemented_types, instance,
             {"warn": false, "mergeDuplicates": true});
